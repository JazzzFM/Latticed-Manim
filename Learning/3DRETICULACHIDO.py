...
class Example(ThreeDScene):
    ...
    def construct(self):
        ...
        def tarugo4D(center, base0, base1, base2, base3):
            proyLAT = 5
            angle = 0
    ...
    #            v[i] = RotZW * v[i]
        ...
        def dominioFundamental4D(center, base0, base1, base2, base3):
            proyLAT = 5
            angle = 0
...
#        dominioFundamental3D(center, Base0, Base1, Base2)
        ...
        #dominioFundamental4D(Center, base0, base1, base2, base3)
    ...
    #        for j in range(0, 1):
    #            for k in range(0, 1):
    #                tarugo4D(Center + (i * base0) + (j * base1) + (k * base2) + (k * base3), base0, base1, base2, base3)
